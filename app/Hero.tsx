  ...
  return (
    <div className="mt-12">
        <div className="flex justify-center">
            <h1 className="font-bold text-[48px] text-[#00203f] text-center w-[1058px]">Medicines, Cars, Dining, Electronics 
        ...
        <div className='flex justify-center flex-col items-center mt-10 pb-10'>
            <div className='flex gap-10'>
                ...
                <div className='bgColorDineEase  px-4 pt-4 pb-8 rounded-[14px] text-center'>
            ...
            <div className='flex gap-10 mt-[40px]'>
                ...
                <div className='bgColorElectronics  px-4 pt-4 pb-8 rounded-[14px] text-center'>
